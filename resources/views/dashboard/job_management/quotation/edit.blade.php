                                            ...
                                            <div class="col-lg-3 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    {{-- <div class="multiselect_div">
                                                        <select id="client" class="multiselect multiselect-custom" name="client_id" disabled>
                                                            <option value="0">- Choose Client -</option>
                                                        </select>
                                                    </div> --}}
                                                    <input type="text" name="client_id" id="client_id" class="form-control" disabled required>
                                                    <input type="text" id="client" value="{{ $quotation->client->id }}" disabled hidden>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-12">
                                                <div class="form-group">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $quotation->heading }}" class="form-control @error('heading') is-invalid @enderror" name="heading" id="heading"/>
                                            </div>
                                        </div>
                                    <div class="col-lg-3 col-md-12">
                                        <div class="form-group">
                                            <label for="phone" class="control-label">Description</label>
                                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="6"> {{ $quotation->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-3 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" min="0.01" class="form-control" name="unit_price" id="unit_price" required/>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-12">
                                            <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-custom spacing8">
                                ...
                                <tbody id="tbl_quote_items">
                                    @foreach ($quotation->quotationHasItems as $key => $item)
                                        <tr>
                                            <td></td>
                                            ...
                                            <td>
                                                <a href="#" class="btn btn-xs btn-warning mr-1 edit"><i class="icon-note"></i></a><a href="#" class="btn btn-xs btn-danger mr-1 delete"><i class="icon-trash"></i></a>
                                                <input type="hidden" class="description" name="quote_items[{{ $key + 1 }}]['description']" value="{{ $item->description }}"/>
                                                <input type="hidden" class="sub_description" name="quote_items[{{ $key + 1 }}]['sub_description']" value="{{ $item->sub_description }}"/>
                                                <input type="hidden" class="unit_price" name="quote_items[{{ $key + 1 }}]['unit_price']" value="{{ $item->unit_price }}"/>
                                                <input type="hidden" class="qty" name="quote_items[{{ $key + 1 }}]['qty']" value="{{ $item->qty }}"/>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var rowId = {{ $quotation->quotationHasItems->count() + 1 }};
            ...
            $('#client_id').val('{{ $quotation->client->name }}');
            ...
            getClientById({{ $quotation->client->id }});
            ...
            function getClientById(client_id) {
                if (client_id != 0) {
                    $.ajax({
                        ...
                        error: function (error) {
                            alert('Cannot get client information');
                        }
                    });
                }
            }
            ...
            // Handling delete button click event on job list table - Default Items
            $('.delete').on('click', function (e) {
                e.preventDefault();
            ...
            // Handling edit button click event on job list table - Default Items
            $('.edit').on('click', function (e) {
                e.preventDefault();
            ...
            $('#createquote').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ config('app.url') }}/quotation/edit/quote",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: {
