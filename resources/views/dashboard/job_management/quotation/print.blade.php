...
<head>
    ...
    <body>
        <page size="A4" id="content">
            {{-- <page size="A4" id="content" style="background: url(/assets/images/print/quotation-bg.png) no-repeat;background-size: 100%;"> --}}
            {{-- <div id="watermark">
            ...
            <table class="w100">
                <tr>
                    ...
                    <td class="text-right">
                        {{-- <h1>Quatation</h1> --}}
                        <table class=" w100" style="margin-top: 112px">
                            <tr>
                                <td class="font-weight-bold text-center"></td>
                                <td class="text-right" style="padding-right: 35px; font-size: 12px;">
                                    {{ $quote->quote_date }}
                                </td>
                            </tr>
                            <tr>
                                <td class="font-weight-bold text-center"></td>
                                <td class="text-right" style="padding-right: 35px; font-size: 12px; padding-top:10px;">
                                    {{ $quote->quote_no }}
                                </td>
                            </tr>
                            <tr>
                ...
                <tr>
                    ...
                    <td style="width: 40%">
                        <table class="w100">
                            <tr style="height: 113px; font-size: 14px;">
            ...
            <!-- <table class="w100 mt10 bordered-tbl">
                <tr>
                    <th class="text-right alter-column"><span class=" pr5 pl5">Qty</span></th>
                    <th class="text-right alter-column"><span class=" pr5 pl5">Rate</span></th>
                    <th class="text-right alter-column"><span class=" pr5 pl5">Amount</span></th>
                </tr>
                {{-- <tr>
            ...
            <table class="w100 mt10" style="padding-top: 96px; font-size: 12px">
                @foreach ($quote->quotationHasItems as $key => $item)
                    <tr>
                        <td style="padding-left: 90px; width: 55%">
                            {{ $item->description }}<br>
                            - {{ $item->sub_description }}
                        </td>
                        <td>
                            <table class="w100 text-right" style="padding-right: 30px">
                                <tr>
