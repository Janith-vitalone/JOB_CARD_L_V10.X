                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show active" id="Home-new2">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-3 col-md-12">
                                                <div class="form-group">
                                                    <label for="phone" class="control-label">Quotaion</label>
                                                    <div class="multiselect_div">
                                                        <select id="quotation" class="multiselect multiselect-custom" name="quotaion_id">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-12">
                                        {{-- <div class="form-group">
                                            ...
                                            <div class="span4 target invoice_ss"></div>
                                        </div> --}}
                                        <div class="avatar-wrapper">
                                            <img src="{{ asset('assets/avatars/default.png') }}" id="avatar" class="img-fluid rounded">
                                            <div class="camera-overlay text-center">
                                                <i class="icon-camera"></i>
                                            </div>
                                        </div>
                                        <form id="upload_img" enctype="multipart/form-data" action="">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group client-note">
                                            ...
                                            <textarea class="form-control @error('job_note') is-invalid @enderror" name="job_note" value="{{ old('job_note') }}" rows="5"></textarea>
                                            @error('job_note')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="po_no" class="form-control @error('po_no') is-invalid @enderror" name="po_no" value="{{ old('po_no') }}" />
                                            @error('po_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" value="" name="width" id="pwidth" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">Height *</label>
                                        <input type="number" step="0.01" value="" name="height" id="pheight" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="messure" class="multiselect multiselect-custom" name="messure">
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="format" class="multiselect multiselect-custom" name="format">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="printer" class="multiselect multiselect-custom" name="printer">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="print_type" class="multiselect multiselect-custom" name="print_type">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="sqft_rate" value="" id="sqft_rate" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="copies" value="" id="copies" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12" hidden>
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="material" class="multiselect multiselect-custom" name="material">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="lamination" class="multiselect multiselect-custom" name="lamination">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="lamination_rate" value="0" id="lamination_rate" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="unit_price" value="" id="unit_price" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        <label for="phone" class="control-label">Total</label>
                                        <input type="number" step="0.01" name="total" id="total" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="multiselect_div">
                                            <select id="finishing" class="multiselect multiselect-custom" name="finishing">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="finishing_rate" value="0" id="finishing_rate" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" value="0" name="product_price" id="product_price" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                ...
                <div class="card">
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    <input name="finish_date" id="finish_date" placeholder="Finish Date" class="form-control datepicker" required>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            //register new client form data store
        ...
        // load all clients to a client selection
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(response.data, function(key, value) {
                        $('#client').append(
                            '<option value="' + value.id + '">' + value.name + " ( "+ value.contact_person + " ) " +'</option>'
                        )
                    });
        ...
        //get quotation by selected client
        $('#client').on('change', function() {
            var client_id = $(this).val();
            $.ajax({
                type: "get",
                url: "{{ config('app.url') }}/client/get/all/quotation/" + client_id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                success: function (response) {
                    ...
                    $('#quotation').append(
                        '<option value="0">- Choose Quotation -</option>'
                    )

                    $.each(response.data, function(key, value) {
                        $('#quotation').append(
                            '<option value="' + value.id + '">' + value.quote_no + '</option>'
                        )
                    });

                    $('#quotation').multiselect('rebuild');
                }
            });
        });
        //get selected quotation details
        $('#quotation').on('change', function() {
            var qutation_id = $(this).val();
            $.ajax({
                type: "get",
                url: "{{ config('app.url') }}/client/get/quotation/" + qutation_id,
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                success: function (response) {
                    ...
                    $.each(response.data.quotation_has_items, function(key, value){
                        console.log(value.description)
                        quota_products += " * Description: " + value.description + "  |  Sub-Description: " + value.sub_description + "  |  Unit price: " + value.unit_price + "  | Qty: " + value.qty +'<br>'
                    });
                    quotation_row += '<tr data-id="{0}">'.format(rowIdPr)
                    quotation_row += '<td>{0}</td>'.format('1')
                    quotation_row += '<td>{0}</td>'.format(response.data.quote_no)
                    quotation_row += '<td>{0}</td>'.format(quota_products)
                    quotation_row += '<td>{0}</td>'.format(response.data.quote_date)
                    quotation_row += '<td>{0}</td>'.format(response.data.total)
                    quotation_row += '</tr>'

                    $('#quotations').append(quotation_row);
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#job_details').on('submit', function(e) {
                ...
                // else if ($format == 0) {
                //     swal('Failed', 'Please Choose Format', 'warning')
                //     return false;
                // } else if ($printer == 0) {
                //     swal('Failed', 'Please Choose Printer', 'warning')
                //     return false;
                // } else if ($print_type == 0) {
                //     swal('Failed', 'Please Choose Print Type', 'warning')
                //     return false;
                // } else if ($sqft_rate.length == 0) {
                //     swal('Failed', 'Please Enter Sqft Rate', 'warning')
                //     return false;
                // } else if($copies.length == 0) {
                //     swal('Failed', 'Please Enter Copies', 'warning')
                //     return false;
                // } else if ($material == 0) {
                //     swal('Failed', 'Please Choose Material', 'warning')
                //     return false;
                // } else if ($lamination == 0) {
                //     swal('Failed', 'Please Choose Lamination', 'warning')
                //     return false;
                // } else if ($finishing == 0) {
                //     swal('Failed', 'Please Choose Finishing', 'warning')
                //     return false;
                // }
                else if($copies.length == 0) {
                    // VALIDATE COPIES / QTY
                ...
                // printer type doesn't select
                // if ($print_type == 0) {
                //     $print_type = $('#print_type').val(0);
                // }
                // sqft rate doesn't select
                ...
                job_row += '<td>{0}</td>'.format($material_name)
            ...
            $('#createjob').on('click', function() {
                ...
                //job_list table data
                var JobsTableData;
                JobsTableData = storeTableValues();

                JobsTableData = JSON.stringify(JobsTableData);
                function storeTableValues(){
                    var JobsTableData = new Array();
                    $('#job_list tr').each(function(row, tr){
                        JobsTableData[row] = {
                            "description" : $(tr).find('.description').val(),
                            "width" : $(tr).find('.width').val(),
                            "height" : $(tr).find('.height').val(),
                            "messure" : $(tr).find('.messure').val(),
                            "format" : $(tr).find('.format').val(),
                            "printer" : $(tr).find('.printer').val(),
                            "print_type" : $(tr).find('.print_type').val(),
                            "sqft_rate" : $(tr).find('.sqft_rate').val(),
                            "copies" : $(tr).find('.copies').val(),
                            "material" : $(tr).find('.material').val(),
                            "lamination" : $(tr).find('.lamination').val(),
                            "unit_price" : $(tr).find('.unit_price').val(),
                            "total" : $(tr).find('.total').val(),
                            "finishing" : $(tr).find('.finishing').val(),
                            "job_type" : $(tr).find('.s_job_type').val(),
                            "job_ss" : $(tr).find('.job_ss').val(),
                            "stock_product_category" : $(tr).find('.stock_product_category').val(),
                            "stock_product" : $(tr).find('.stock_product').val(),
                        };
                    });
                ...
                //products table data
                var ProductsTableData;
                ProductsTableData = storeTblValues();

                ProductsTableData = JSON.stringify(ProductsTableData);
                function storeTblValues(){
                    var ProductsTableData = new Array();
                ...
                console.log('pp list', ProductsTableData);

                var formData = new FormData();
                formData.append('client_id', $client);
                formData.append('client_note', $clientNote);
                formData.append('designer', $designer);
                formData.append('job_note', $jobNote);
                formData.append('finish_date', $finish_date);
                formData.append('finish_time', $finish_time);
                formData.append('job_list', JobsTableData);
                formData.append('product_list', ProductsTableData);
                formData.append('po_no', $poNo);
                formData.append('quote_no', $quote_id);
                // Attach file
                formData.append('screenshot',$('#avatarfile').prop('files')[0]);
                console.log(formData);
                console.log("end");
                $('#createjob > div').css('display', 'block');
                $('#createjob > span').css('display', 'none');

                var $quote_id = $('#quotation').val();
                console.log($quote_id);
                // Sending Ajax Request
                $.ajax({
                    type: "POST",
                    url: "{{ config('app.url') }}/jobcard/new/job",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    cache : false,
                    ...
                    error: function (error) {
                        swal('Error', 'Unable to create job, please try again later', 'error');
                    },
                    complete: function () {
                        $('#createjob > div').css('display', 'none');
            ...
            $('#finish_date').on('change', function() {
                ...
                if (weekday[a.getDay()] == 'Saturday') {
                    ...
                    $('#finish_time').multiselect('destroy')
                    $('#finish_time').multiselect({
                        enableFiltering: true,
                        enableCaseInsensitiveFiltering: true,
                        maxHeight: 200
