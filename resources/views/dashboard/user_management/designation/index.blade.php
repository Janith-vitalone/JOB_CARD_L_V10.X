...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2>Designations <small>Use this section to manage designations</small></h2>
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table id="designations" class="table table-hover table-custom spacing8">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
        ...
        $(function() {
           var table = $('#designations').DataTable({
               ...
               fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    ...
                    var actions = '<a href="{{ route("designation.index") }}/' + aData['id']+ '/edit" class="btn btn-xs btn-warning mr-1"><i class="icon-note"></i></a>';
                    actions += `<form action="{{ route("designation.index") }}/` + aData['id']+ `" method="post" onsubmit="return confirm('Are you sure you want to delete?');" style='display: -webkit-inline-box;'>`;
