                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input data-provide="datepicker" value="{{ old('dob') }}" name="dob" data-date-format="yyyy-mm-dd" data-date-autoclose="true" class="form-control @error('dob') is-invalid @enderror" required>
                                            @error('dob')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="col-lg-4 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="contact_no" value="{{ old('contact_no') }}" class="form-control phone-number @error('contact_no') is-invalid @enderror" placeholder="Ex: 07x xxx xxxx" required>
                                            @error('contact_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
