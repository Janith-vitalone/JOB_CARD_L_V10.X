    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>Create new Other Payment</h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <form action="{{ route('other-payment.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bank" id="bank" value="{{ old('bank') }}" class="form-control @error('bank') is-invalid @enderror">
                                        @error('bank')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description') }}" rows="5"></textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cheque_no" id="cheque_no" value="{{ old('cheque_no') }}" class="form-control @error('cheque_no') is-invalid @enderror">
                                        @error('cheque_no')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <label for="phone" class="control-label">Banking Date</label>
                                        <input name="banking_date" id="banking_date" placeholder="Banking Date" class="form-control datepicker @error('banking_date') is-invalid @enderror">
                                        @error('banking_date')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
