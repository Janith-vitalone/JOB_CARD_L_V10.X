...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    <h2>Units <small>Use this section to manage Units</small></h2>
    ...
    <script>
        $(function() {
           var table = $('#printers').DataTable({
               ...
               "searching": false,
               "ajax": {
                   url: "{{ config('app.url') }}/unit/get/all",
                   type: "GET",
                   cache: false,
                   error: function(){
               ...
               fnRowCallback: function(nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                    ...
                    var actions = '<a href="{{ route("unit.index") }}/' + aData['id']+ '/edit" class="btn btn-xs btn-warning mr-1" ><i class="icon-note"></i></a>';
                    actions += `<form action="{{ route("unit.index") }}/` + aData['id']+ `" method="post" onsubmit="return confirm('Are you sure you want to delete?');" style='display: -webkit-inline-box;'>`;
