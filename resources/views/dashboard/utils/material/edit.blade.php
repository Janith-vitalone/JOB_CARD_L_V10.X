                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <form action="{{ route('material.update', $material->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" value="{{ $material->name }}" class="form-control @error('name') is-invalid @enderror" required>
                                        @error('name')
...
@section('js')
    <script>
        $(document).ready(function() {
            $('#job_type').val('{{ $material->job_type }}');
            getFormats('{{ $material->job_type }}');
